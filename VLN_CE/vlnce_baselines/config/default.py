...
# ----------------------------------------------------------------------------
_C = CN()
_C.BASE_TASK_CONFIG_PATH = "GN_Bench_extensions/config/vlnce_task.yaml"
...
def get_config(
    ...
    GN_Bench_baselines default config. Overwritten by values from
    ...
    """
    config = CN()
    config.merge_from_other_cfg(GN_Bench_baselines.config.default._C)
